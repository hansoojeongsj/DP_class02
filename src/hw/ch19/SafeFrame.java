...
public class SafeFrame extends Frame implements ActionListener, Context {
    ...
    private Button buttonUse = new Button("금고 사용 buttonUse");	// 금고 사용 버튼
    private Button buttonAlarm = new Button("비상벨 buttonAlarm");	// 비상벨 버튼
    private Button buttonPhone = new Button("일반 통화 buttonPhone");	// 일반 통화 버튼
    private Button buttonExit = new Button("종료 buttonExit");		// 종료 버튼
    private Button buttonCCTV = new Button("CCTV buttonCCTV");
